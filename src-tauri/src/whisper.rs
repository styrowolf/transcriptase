...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, clap::ValueEnum, enum_iterator::Sequence)]
pub enum Language {
    #[clap(name = "auto")]
    Auto,
    #[clap(name = "en")]
...
impl Whisper {
    ...
    pub async fn new_tauri<R: tauri::Runtime>(
        model: Model,
        lang: Option<Language>,
    ...
    pub fn transcribe<P: AsRef<Path>>(
        ...
        unsafe {
            params.set_progress_callback(Some(progress::tauri_progress_callback));
        }
        ...
        for s in 0..num_segments {
            ...
            utterances.push(Utterance { text, start, stop });
